...
if __name__ == '__main__':
    output_folder_name = 'my_output_folder'
    epoch_number = 35
    model_name = 'my_model_name'
    delete_token_mappings = False # fara argumente

    try:
      opts, args = getopt.getopt(sys.argv[1:],"ho:e:m:",["output=","epoch=","model="])
    except getopt.GetoptError:
      print('prepare_pretrained_model.py -o <output_folder> -e <epoch> -m <model_name>')
      sys.exit(2)
    ...
    print("%s [%d] ====> %s"%(output_folder_name, epoch_number, model_name))
