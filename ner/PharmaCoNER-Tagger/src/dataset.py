...
class Dataset(object):
    ...
    def update_dataset(self, dataset_filepaths, dataset_types, parameters):
        ...
        self.affs={}
        for dataset_type in dataset_types:
            self.labels[dataset_type], self.tokens[dataset_type], _, _, _,self.pos_tags[dataset_type], _, self.gazs[dataset_type], _, self.affs[dataset_type],_ = self._parse_dataset(dataset_filepaths.get(dataset_type, None),parameters)
